...
DETECTION_SERVER_URL = "http://andrexcodes.local:3000/ocr/uppercase-center"  # Update with your server IP
...
class DetectionManager:
    ...
    def __init__(self, server_url, timeout=DETECTION_TIMEOUT):
    ...
    def _detect_sync(self, frame):
        ...
        try:
            ...
            print("Detection request timeout")
            return None
        except requests.exceptions.ConnectionError:
            print("Cannot connect to detection server")
            return None
        except Exception as e:
...
detection_manager = DetectionManager(DETECTION_SERVER_URL)
...
if __name__ == "__main__":
    ...
    print(f"   • Detection Server: {DETECTION_SERVER_URL}")
